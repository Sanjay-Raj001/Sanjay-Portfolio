  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
      <div className='max-w-[1300px] mx-auto  flex justify-between text-gray-200
        ...
        <a href="#" className="custom-logo"> &lt;Sanjay Raj/&gt; </a>


        <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
          <li className='group relative'>
            <Link to="about" smooth={true} offset={50} duration={500}>About</Link>
            <span className="absolute bottom-0 left-0 w-full h-1  bg-gradient-to-r from-orange-400 to-pink-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-in-out"></span>
          </li>
          <li className='group relative'>
        ...
        <div onClick={toggleNav} className='md:hidden z-50 text-gray-200'>
          {nav ? <AiOutlineClose size={30} /> : <TbMenuDeep size={30} />}
        </div>
        ...
        >
          <ul className='font-semibold text-4xl space-y-8 mt-24 text-center cursor-pointer'>
            ...
            <li ><Link to="about" onClick={closeNav} smooth={true} offset={50} duration={500} >About</Link>
            </li>
